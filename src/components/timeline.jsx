              ...
              <div className="col-md-12">
                ...
                <article className="timeline-entry animate-box" data-animate-effect="fadeInTop">
                    <div className="timeline-entry-inner">
                      ...
                      <div className="timeline-label">
                        ...
                        <p> Employed as a Software Engineer from July 2022 till March 2023 in Delhi/Gurgaon with a hybrid work model. At First I built clone of a Gmail like messaging system as a demo project on spring and react.
                            I Learnt in detail about Java Programming language from tutorials point and JavaBrains videos on youtube. After that I learnt about Spring Framework following online tutorials provided by the tech lead and other team members.
                            For my first task I was provided with a sample thak you page in Zoho platform built using deluge coding language. I had to fetch the referral code for each user from the databse and display it on the thank you page. Also designed the UI of the same using HTML and CSS.
                            After getting familiar with the environment I solved a few bugs on it using deluge coding and then setup the codebase in java, Javascript, ruby on rails. Also setup the Tables /database. and access for staging and production.
                            Then I studied and solved bugs in Java, Javascript. Tested the bugs on localhost along with data visualisation on tables after Writing
                            database migrations. Having properly checked the bugs we deploy it to staging and production url.
                             Also we were to design a messaging system to send notification on sms, slack or salesforce when the class start and teacher has joined the meet. 
                           </p>
                      </div>
                    </div>
                  </article>
                ...
                <article className="timeline-entry animate-box" data-animate-effect="fadeInTop">
                    <div className="timeline-entry-inner">
                      ...
                      <div className="timeline-label">
                        <h2>Software Developer Trainee at Rakuten India <span>2021-2022</span></h2>
                        <p> Worked as a Trainee consultant at Rakuten as Work From Home. I had a six month contract as a Trainee Consultant during thr covid pandemic time. We analysed the issues on their testing/QA site called ATSSA.AI or Rakuten Sixth
                        Sense and worked on feature implementations and solving bugs on the frontend.
                  ...
                  <article className="timeline-entry animate-box" data-animate-effect="fadeInTop">
                    <div className="timeline-entry-inner">
                      ...
                      <div className="timeline-label">
                        ...
                        <p> I completed my Integrated Mtech undertaking courses like Game Theory and Internet Of Things. For my MTech project I did my research thesis on Deep Dream, a computer generated art form. It uses deep learning to produce halucogenic effects on a given image. In layman terms we can think about it like
                  ...
                  <article className="timeline-entry animate-box" data-animate-effect="fadeInTop">
                    <div className="timeline-entry-inner">
                      ...
                      <div className="timeline-label">
                        <h2>Participated in GSOC 2020 under AOSSIE Organisation  <span>2020</span></h2>
                        <p> I proposed to add a functionality for detecting NSFW Images to the existing Social Street Smart porject extension and solved minor bugs and made pull request for the same. A chrome extension for detecting and blurring out NSFW Images which
                        fetches information from a rest-api, serving prediction of a
                  ...
                  <article className="timeline-entry animate-box" data-animate-effect="fadeInTop">
                    <div className="timeline-entry-inner">
                      ...
                      <div className="timeline-label">
                        ...
                        <p> Qualified Gate 2020 in Computer Science (CS) with score: 42 / 100 and rank: 3285  </p>
                      </div>
                    </div>
                  </article>
                  <article className="timeline-entry animate-box" data-animate-effect="fadeInTop">
